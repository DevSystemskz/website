...
export function PortfolioCard({
  ...
  return (
    <Link href={`/portfolio/${slug}`} className="block h-full">
      <motion.article
        className="group h-full overflow-hidden border border-line bg-canvas-elevated dark:border-line-dark dark:bg-canvas-elevated-dark"
      ...
      >
        <div className="relative h-44 w-full overflow-hidden bg-canvas-muted dark:bg-canvas-dark">
          ...
          <div className="absolute bottom-3 left-3 font-mono text-[10px] uppercase tracking-wider text-white/0 transition-colors group-hover:text-white/80">
            {viewLabel}
          </div>
        </div>
